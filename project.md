  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p>{{project.names}}</p>
        <p><a href="{{project.paper-url}}" style="width:25%">Paper</a> | <a href="{{project.pres-url}}" style="width:50%>Presentation</a> | <a href="{{project.slide-url}}" style="width:25%>Slides</a></p>
      </div>
    </div>
  </div>
  {% endfor %}
